...
type Labor struct {
	...
	UserID          uint            `gorm:"not null;index;index:idx_labors_user_date,priority:1;index:idx_labors_user_mobile,priority:1;default:0" json:"user_id"`
	...
	Date            time.Time       `gorm:"not null;index:idx_labors_user_date,priority:2" json:"date"`
	Mobile          *string         `gorm:"type:varchar(15);index:idx_labors_user_mobile,priority:2" json:"mobile,omitempty"`
